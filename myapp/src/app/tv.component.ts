...
@Component({
    ...
    template: `
    <div class="container">
    <h3 class="h3">TV Products</h3>
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6" *ngFor="let md of TV">
    ...
    .product-grid .product-image img{width:auto;height:100px}
...
export class TVComponent{
    TV =[
        ...
        name: "JVC",
        price: 12000,
        imgURL: "../assets/img/TV/jvc-43n7105c-original-imafeupdfwhf2sen.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Kodak",
        price: 13000,
        imgURL: "../assets/img/TV/kodak-32hdx900s-bt-original-imafe7zgstjv6xek.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Micromax",
        price: 15000,
        imgURL: "../assets/img/TV/micromax-32t8361hd2019-32ips200hd-original-imafggs9mkyuuauf.jpeg",
        rating: [1,2,3,4,5]
    },
    {
        name: "MI",
        price: 17000,
        imgURL: "../assets/img/TV/mi-l43m5-an-original-imafhys8bhtqppnm.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Sony",
        price: 11000,
        imgURL: "../assets/img/TV/sony-klv-32w622f-original-imaf98nwzu7f3urq.jpeg",
        rating: [1,2,3,4,5]
    },
    {
        name: "Thomson B9 PRO",
        price: 9000,
        imgURL: "../assets/img/TV/thomson-b9-pro-32m3277-original-imaf637gjtzxhhzh.jpeg",
        rating: [1,2,3,4]
    }
];
