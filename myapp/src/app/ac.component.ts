...
@Component({
    ...
    template: `
    <div class="container">
    <h3 class="h3">AC Products</h3>
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6" *ngFor="let md of AC">
...
export class AcComponent{
    AC =[
        ...
        name: "Voltas",
        price: 12000,
        imgURL: "../assets/img/AC/155v-dzw-r32-1-2-split-voltas-inverter-original-imaffdt8gyxqxfae.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Micromax",
        price: 13000,
        imgURL: "../assets/img/AC/acs12c3t3qs6wh-1-split-micromax-original-imafe7zwygzh9gdq.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Panasonic",
        price: 15000,
        imgURL: "../assets/img/AC/cs-cu-tu18vkyw-1-5-inverter-panasonic-original-imafess5xvbhzdem.jpeg",
        rating: [1,2,3,4,5]
    },
    {
        name: "Godrej",
        price: 17000,
        imgURL: "../assets/img/AC/gsc-18ktc3-wsa-1-5-split-inverter-godrej-original-imafhbm5agmxsbju.jpeg",
        rating: [1,2,3,4]
    },
    {
        name: "Marq",
        price: 11000,
        imgURL: "../assets/img/AC/fkac103siainc-1-inverter-marq-by-flipkart-original-imafehzvz2xccvyy.jpeg",
        rating: [1,2,3,4,5]
    },
    {
        name: "LG",
        price: 9000,
        imgURL: "../assets/img/AC/ks-q18ynza-1-5-split-lg-original-imafdf88xhtpm7ug.jpeg",
        rating: [1,2,3,4]
    }
];
